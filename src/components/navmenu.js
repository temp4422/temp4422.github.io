      ...
      <nav class="nav">
        ...
        <div class="nav__panel">
          <div class="nav__panel__top">
            ...
            <a class="nav__link" href="/src/pages/svg-sprites.html" aria-label="link to page">
              <div class="svg nav__svg">
